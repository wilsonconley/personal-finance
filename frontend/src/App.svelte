<script>
  ...
  // import balancesTable from "./assets/balances_table.svg";
  import Counter from "./lib/Counter.svelte";
  // import htmlContent from "./assets/balances.html";
  // import "./assets/balances.html";
  ...
  const balances_cols = [
    ...
    { key: "balances", title: "Balance", value: (v) => v.balances },
  ];
